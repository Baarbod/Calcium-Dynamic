classdef GuiInterface < handle
    properties
        ...
        State             % array of current state variable
        ResetHandle       % reset button handle
        AxisHandle        % axis handles
        Name              % name of gui figure
    end
    methods
        
        % constructor
        function obj = GuiInterface(Position,Name)
            obj.Position = Position;
            obj.Name = Name;
            obj.SliderCount = 0;
            obj.Figure = figure('Visible','on','Position',obj.Position,...
                'Name',obj.Name);
        ...
        function obj = createplot(obj)
            obj.AxisHandle.h(1) = axes('Units','normalized',...
                'Position',[0.05,0.525,0.275,0.425]);
            obj.AxisHandle.h(2) = axes('Units','normalized',...
                'Position',[0.375,0.525,0.275,0.425]);
            obj.AxisHandle.h(3) = axes('Units','normalized',...
                'Position',[0.05,0.05,0.275,0.425]);
            obj.AxisHandle.h(4) = axes('Units','normalized',...
